...
},
{
    url: "/byCatId/{id}",
    get: {
        summary: "get Store By category Id",
        description: "get Store By category Id",
        parameters: [
            // {
            //     in: "header",
            //     name: "x-access-token",
...
{
    url: "/checkUserHaveStore/{id}",
    get: {
        summary: "check User Have Store by user id",
        description: "check User Have Store by user id",
        parameters: [
            // {
            //     in: "header",
            //     name: "x-access-token",
